...
export function BigStat({
  ...
  return (
    <div className="rounded-panel border border-line bg-console-2/50 px-2 py-1">
      ...
      <div className={`telemetry text-base leading-tight ${accent ? 'text-phosphor' : 'text-starlight'}`}>
        {value}
...
export function FuelGauges() {
  ...
  return (
    <div className="space-y-1.5">
      {t.stages.map((s, i) => (
        <div key={i} className="rounded-panel border border-line bg-console-2/50 p-1.5">
      ...
      <div className="rounded-panel border border-line bg-console-2/50 p-1.5">
        <div className="font-display text-[9px] uppercase tracking-wider text-muted-star">
          <InfoChip conceptId="max-q">Dynamic pressure</InfoChip>
        </div>
        <div className="telemetry mt-0.5 text-base leading-tight text-starlight">
          {(t.q / 1000).toFixed(1)}
